...
local gc_list = {
    ...
    [ 0x4A6C ] = {0x12, 'STFT',        10, 2, -25, 25,  '%',   's', 1, 1000, 0},
    [ 0x580F ] = {0x12, 'IAT',         25, 1, 0, 200,   'F',   'u', 1.35, 1, -54.4},
    [ 0x5813 ] = {0x12, 'LoadActual',  5,  1, nil, nil, '%',   'u', 0.75, 1, 0},
    [ 0x480C ] = {0x12, 'LoadTarget',  5,  1, nil, nil, '%',   'u', 0.75, 32, 0}, 	
    [ 0x586F ] = {0x12, 'OilPress',    1,  1, 0, 100,   'psi', 's', 14.696, 1013.25, 0}, 
    [ 0x5889 ] = {0x12, 'Lambda',      50, 2, 0, 2,     '',    'u', 16, 65535, 0}, 
    [ 0x5890 ] = {0x12, 'CoolantOut',  1,  1, 0, 300,   'F',   'u', 1.35, 1, -54.4},
    [ 0x59FA ] = {0x12, 'IgnTiming',   50, 1, nil, nil, '*',   's', 0.75, 1, 0},
}
